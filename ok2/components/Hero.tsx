  ...
  return (
    <section id="top" className="relative h-screen w-full flex flex-col justify-center items-center bg-white overflow-hidden">
      ...
      <div className="container mx-auto px-6 z-10 text-center">
        {/* Logo - Matching Business Card Boldness */}
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-ok-black mb-6 leading-tight">
          OK<span className="text-3xl md:text-5xl font-black ml-1 relative -top-6 md:-top-10">2</span><span className="ml-2 text-5xl md:text-7xl font-black">inc.</span>
        </h1>
        {/* Subtitle - Heavier weight to match card readability */}
        <div className="flex flex-col md:flex-row items-center justify-center space-y-2 md:space-y-0 md:space-x-4 text-sm md:text-xl font-medium tracking-widest text-gray-600 uppercase mt-4">
